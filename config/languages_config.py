...
_QT_EXTRA_LABELS = {
    "en": {
        ...
        "Browse": "Browse",
        "API Key Not Set": "API key is not set yet — enter it above or in Settings.",
        "Image": "Image",
        "Media": "Audio / Video",
    ...
    "zh": {
        ...
        "Output Folder": "输出文件夹",
        "Browse": "浏览",
        "API Key Not Set": "尚未设置 API 密钥——请在上方或设置中填写。",
        "Image": "图像",
        "Media": "音视频",
        "Unavailable": "不可用",
    ...
    "zh-Hant": {
        ...
        "Output Folder": "輸出資料夾",
        "Browse": "瀏覽",
        "API Key Not Set": "尚未設定 API 金鑰——請在上方或設定中填寫。",
        "Image": "圖像",
        "Media": "音視訊",
        "Unavailable": "不可用",
    ...
    "ja": {
        ...
        "Browse": "参照",
        "API Key Not Set": "APIキーが未設定です。上部または設定で入力してください。",
        "Image": "画像",
        "Media": "音声・動画",
        "Unavailable": "利用不可",
