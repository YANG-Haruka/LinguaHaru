...
_QT_EXTRA_LABELS = {
    "en": {
        ...
        "Browse": "Browse",
        "API Key Not Set": "API key is not set yet — set it on the Settings tab.",
    ...
    "zh": {
        ...
        "Output Folder": "输出文件夹",
        "Browse": "浏览",
        "API Key Not Set": "尚未设置 API 密钥——请在“设置”中填写。",
    ...
    "zh-Hant": {
        ...
        "Output Folder": "輸出資料夾",
        "Browse": "瀏覽",
        "API Key Not Set": "尚未設定 API 金鑰——請在「設定」中填寫。",
    ...
    "ja": {
        ...
        "Browse": "参照",
        "API Key Not Set": "APIキーが未設定です。「設定」タブで入力してください。",
