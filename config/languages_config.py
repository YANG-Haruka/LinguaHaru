...
LABEL_TRANSLATIONS = {
    ...
    "en": {
        ...
        "Upload File": "Upload Office File (.docx, .pptx, .xlsx)",
        "Upload Files": "Upload Files",
        "Supported File Types": "Supported file types: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "zh": {
        ...
        "Upload File": "上传文件 (.docx, .pptx, .xlsx)",
        "Upload Files": "上传文件",
        "Supported File Types": "支持的文件类型：.docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "zh-Hant": {
        ...
        "Upload File": "上傳檔案 (.docx, .pptx, .xlsx)",
        "Upload Files": "上傳檔案",
        "Supported File Types": "支援的檔案類型：.docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "ja": {
        ...
        "Upload File": "ファイルをアップロード (.docx, .pptx, .xlsx)",
        "Upload Files": "ファイルをアップロード",
        "Supported File Types": "対応ファイル形式：.docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "es": {
        ...
        "Upload File": "Subir archivo (.docx, .pptx, .xlsx)",
        "Upload Files": "Subir archivos",
        "Supported File Types": "Tipos de archivo compatibles: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "fr": {
        ...
        "Upload File": "Télécharger le fichier (.docx, .pptx, .xlsx)",
        "Upload Files": "Télécharger les fichiers",
        "Supported File Types": "Types de fichiers pris en charge : .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "de": {
        ...
        "Upload File": "Datei hochladen (.docx, .pptx, .xlsx)",
        "Upload Files": "Dateien hochladen",
        "Supported File Types": "Unterstützte Dateitypen: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "it": {
        ...
        "Upload File": "Carica file (.docx, .pptx, .xlsx)",
        "Upload Files": "Carica file",
        "Supported File Types": "Tipi di file supportati: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "pt": {
        ...
        "Upload File": "Enviar arquivo (.docx, .pptx, .xlsx)",
        "Upload Files": "Enviar arquivos",
        "Supported File Types": "Tipos de arquivo suportados: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "ru": {
        ...
        "Upload File": "Загрузить файл (.docx, .pptx, .xlsx)",
        "Upload Files": "Загрузить файлы",
        "Supported File Types": "Поддерживаемые типы файлов: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "ko": {
        ...
        "Upload File": "파일 업로드 (.docx, .pptx, .xlsx)",
        "Upload Files": "파일 업로드",
        "Supported File Types": "지원 파일 형식: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "th": {
        ...
        "Upload File": "อัปโหลดไฟล์ (.docx, .pptx, .xlsx)",
        "Upload Files": "อัปโหลดไฟล์",
        "Supported File Types": "ประเภทไฟล์ที่รองรับ: .docx, .pptx, .xlsx, .srt, .txt, .md",
    ...
    "vi": {
        ...
        "Upload File": "Tải lên tệp (.docx, .pptx, .xlsx)",
        "Upload Files": "Tải lên tệp",
        "Supported File Types": "Các loại tệp được hỗ trợ: .docx, .pptx, .xlsx, .srt, .txt, .md",
