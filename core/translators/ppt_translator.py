from core.pipelines.ppt_translation_pipeline import extract_ppt_content_to_json, write_translated_content_to_ppt
...
class PptTranslator(DocumentTranslator):
    ...
    def write_translated_json_to_file(self, json_path, translated_json_path,progress_callback=None):
        write_translated_content_to_ppt(self.input_file_path, json_path, translated_json_path, self.temp_dir, self.result_dir, self.src_lang, self.dst_lang)
